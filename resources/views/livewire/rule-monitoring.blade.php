<div>
    <x-jet-action-section>
        ...
        <x-slot name="content">
            ...
            <div>Actions performed: <strong>{{ $this->rule->actionsTotal - $this->rule->leftaction($this->rule->id) }}</strong></div>
            <div>Actions left: <strong>{{ $this->rule->leftaction($this->rule->id) }}</strong></div>
